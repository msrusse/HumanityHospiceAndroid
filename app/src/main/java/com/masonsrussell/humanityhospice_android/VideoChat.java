...
//        Boolean c1 = checkSelfPermission(REQUESTED_PERMISSIONS[0], PERMISSION_REQ_ID);
//        Boolean c2 = checkSelfPermission(REQUESTED_PERMISSIONS[1], PERMISSION_REQ_ID);
//
//        if (c1 && c2) {
//            // All Good
...
//        } else if (c1 == false) {
//            // Req C1
//            String[] perm = {REQUESTED_PERMISSIONS[0]};
//            ActivityCompat.requestPermissions(this, perm, PERMISSION_REQ_ID);
//        } else {
//            // Req C2
//            String[] perm = {REQUESTED_PERMISSIONS[1]};
//            ActivityCompat.requestPermissions(this, perm, PERMISSION_REQ_ID);
//        }
    ...
    private void initializeAgoraEngine() {
        try {
            mRtcEngine = RtcEngine.create(this, "03a816bd23514d8da3f596d3d4d95562", mRtcEventHandler);
        } catch (Exception e) {
...
//                VideoEncoderConfiguration.ORIENTATION_MODE.ORIENTATION_MODE_FIXED_PORTRAIT));
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(null, uid, "Extra Optional Data", 0);
    }
